...
export const getPools = value => {
  return new Promise((resolve, reject) => {
    axios
      .post(config.api_service_url + '/pool/list', {
        filter: value,
        page: 1,
        limit: 20
      })
...
export const getPoolsByCategory = value => {
  return new Promise((resolve, reject) => {
    axios
      .post(config.api_service_url + '/pool/list/category', {
        category: value,
        page: 0,
        limit: 5
      })
...
export const getPoolsForAccountActive = account => {
  return new Promise((resolve, reject) => {
    axios
      .post(config.api_service_url + '/pool/account/active', {
        account: account,
        page: 0,
        limit: 5
      })
...
export const getPoolsForAccountPast = account => {
  return new Promise((resolve, reject) => {
    axios
      .post(config.api_service_url + '/pool/account/finished', {
        account: account,
        page: 0,
        limit: 5
      })
