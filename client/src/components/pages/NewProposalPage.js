...
class RegistrationForm extends React.Component {
  ...
  render() {
    ...
    return (
      <Form onSubmit={this.handleSubmit} style={{ padding: '30px 350px', marginLeft: '-300px' }}>
        ...
        <FormItem {...formItemLayout} label="Education course">
          {getFieldDecorator('email', {
            rules: [
              {
                type: 'email',
                message: 'The input is not a valid education course!'
              },
              {
                required: true,
                message: 'Please input your education course!'
              }
            ]
          })(<Input />)}
        </FormItem>
        <FormItem {...formItemLayout} label="Other participants">
          {getFieldDecorator('email', {
            rules: [
              {
                type: 'email',
