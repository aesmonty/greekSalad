...
class Contract(Abstract_Contract):
    ...
    def publish(self, account_address, quorum_size,min_debate,margin):
        ...
        trans_hash = my_contract.constructor(quorum_size,min_debate,margin).transact(transaction={'from':account_address})
